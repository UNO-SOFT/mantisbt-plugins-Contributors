...
\t\tVALUES ( " . db_param() . ',' . db_param() . ',' . db_param() . ',' . db_param() . ','
    ...
    db_query($t_history_query, array(auth_get_current_user_id(), db_now(), $p_bug_id, $p_user_id, $p_row['cents'], $t_deadline, $t_validity, $p_row['description']));
    ...
    db_query($t_query, array($p_bug_id, $p_user_id, $p_row['cents'], $t_deadline, $t_validity, $p_row['description']));
}
